...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="600" height="400" viewBox="0 0 600 400">
  ...
  <rect x="30" y="30" width="540" height="340" rx="16" fill="white" stroke="#e2e8f0" stroke-width="2"/>
...
cloudinary.uploader.upload(dataUrl, {
  folder: 'sikelas',
  public_id: 'default_proof',
  format: 'png',
  width: 600,
  height: 400,
  overwrite: true,
}).then(res => {
  console.log('SUCCESS! New Cloudinary URL:', res.secure_url);
