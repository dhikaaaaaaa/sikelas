...
const isOAuthConfigured = clientID && clientSecret && clientID !== 'your_google_client_id_here';
...
if (isOAuthConfigured) {
  ...
  console.warn('⚠️ GOOGLE_CLIENT_ID / GOOGLE_CLIENT_SECRET belum dikonfigurasi di backend/.env');
}
